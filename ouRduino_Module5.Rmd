...
## Methods
A DS18B20 precision linear digital temperature sensor was used with an Aduino Uno, that required ArduinoIDE software. The probe was used to measure the axillary temperature of two test subjects for 100 seconds at a resting state, and after five minutes of jumping jacks.
...
Michael Bevilacqua: put together the arduino unit and the temperature probe, wrote the sketch for the probe, and wrote the code and the narrative of our findings in the results section. (edited all written sections)

Alexandra Hoogendijk: wrote the introduction and discussion,  found the studies that are cited and created the bibliography. (edited all written sections)
