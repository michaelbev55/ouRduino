...
```
## Introduction
In this study, students measured their body temperatures at two different states: active and rest. The goal of this study is to find if body temperature varies in human subjects according to activity level. A previous study 
...
Alexandra Hoogendijk: found the article and cited the study in the introduction that and cited and commented on a study in the discussion that frames the results. 
